...
//                buildAndShowNotification(title,body, pendingIntent)
//            }
//        }
//    }
    ...
    override fun handleIntent(intent: Intent?) {
        ...
        Log.d("TAG", "handleIntent URI:"+intent?.action)
        if (intent?.action == "com.google.android.c2dm.intent.RECEIVE") {
//            val remoteMessage = intent.getParcelableExtra<RemoteMessage>("com.google.android.c2dm.intent.RECEIVE")
//            Log.d("TAG", "handleIntent URI:"+intent)
            intent.getStringExtra("Key")?.let { url ->
//                val url = data["Key"]
                ...
                Log.d("TAG", "handleIntent:title&body$title$body")
